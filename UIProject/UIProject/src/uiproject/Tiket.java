...
public class Tiket {
    ...
    public void setStock() {
        this.stock = (getRegTickets() + getVipTickets());
    }
    ...
    public Tiket(String creatorName, String eventName, String location, LocalDate eventDate, double regPrice, double vipPrice, int stock, LocalDateTime endTime) { 
        this.creatorName = creatorName;
        this.eventName = eventName;
        this.location = location;
        this.eventDate = eventDate;
    ...
    public Tiket(String creatorName, String eventName, String location, LocalDate eventDate, LocalTime jam, int reg, int vip,  double regPrice, double vipPrice,  LocalDateTime endTime) { //this constructor untuk pas buat tiket
