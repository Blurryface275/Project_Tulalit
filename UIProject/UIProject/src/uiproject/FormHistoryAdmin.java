 ...
 * @author LENOVO
 */
public class FormHistoryAdmin extends javax.swing.JFrame {

    /**
     * Creates new form FormCheckout
     */
    public FormHistoryAdmin() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnEvents2.setToolTipText("");

        btnEvents3.setBackground(new java.awt.Color(153, 0, 51));
        btnEvents3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        btnEvents3.setForeground(new java.awt.Color(255, 255, 255));
        btnEvents3.setText("LAPORAN");
        btnEvents3.setToolTipText("");
        btnEvents3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnEvents3ActionPerformed(evt);
            }
        });
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nama Pembeli", "Jenis Tiket", "Tanggal Dibeli", "Harga Satuan", "Jumlah Terjual", "Subtotal", "Status"
            }
        ) {
            Class[] types = new Class [] {
                java.lang.Object.class, java.lang.String.class, java.lang.Object.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.Integer.class, java.lang.String.class
            };
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Event 1", "Event 2", "Event 3" }));
    ...
    private void btnEventsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEventsActionPerformed
        this.dispose();
        FormCreateTicket cre = new FormCreateTicket();
        cre.setVisible(true);        // TODO add your handling code here:
    }//GEN-LAST:event_btnEventsActionPerformed

    private void btnEvents3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEvents3ActionPerformed
        // TODO add your handling code here:
        this.dispose();
        FormLaporanAdmin lap = new FormLaporanAdmin();
        lap.setVisible(true);
    }//GEN-LAST:event_btnEvents3ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormHistoryAdmin().setVisible(true);
            }
        });
    }
